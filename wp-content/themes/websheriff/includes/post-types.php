...
{
    $labels = [
        'name'                  => _x('Workouts', 'Post Type General Name', 'text_domain'),
        'singular_name'         => _x('Workout', 'Post Type Singular Name', 'text_domain'),
        'menu_name'             => __('Workouts', 'text_domain'),
        'name_admin_bar'        => __('Workouts', 'text_domain'),
        'archives'              => __('Item Archives', 'text_domain'),
        'attributes'            => __('Item Attributes', 'text_domain'),
        'parent_item_colon'     => __('Parent Item:', 'text_domain'),
        'all_items'             => __('All Items', 'text_domain'),
    ...
    $args = [
        'label'               => __('Workout', 'text_domain'),
        'description'         => __('Workout', 'text_domain'),
        'labels'              => $labels,
        'supports'            => ['title', 'revisions'],
        'hierarchical'        => false,
        'public'              => false,
